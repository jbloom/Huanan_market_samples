...
For instance, 14 samples have $>$20\% of their chordate mitochondrial DNA from raccoon dogs, but only one of these samples contains any SARS-CoV-2 reads, and that sample only has 1 of $\sim$200,000,000 reads mapping to SARS-CoV-2.
...
\begin{tabular}{llrrr}
\toprule
species      &   sample              & \makecell[r]{mitochondrial \\ reads from \\ species} &  \makecell[r]{reads \\ aligning \\ to SARS2} & \makecell[r]{ total pre-\\processed \\ reads} \\ 
\midrule
